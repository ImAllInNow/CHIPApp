...
public class ConfirmationDialog extends DialogFragment {
    ...
    public static final String ARG_MESSAGE_TITLE = "chiprogram.chipapp.ARG_MESSAGE_TITLE";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String m_messageTitle = getArguments().getString(ARG_MESSAGE_TITLE);
